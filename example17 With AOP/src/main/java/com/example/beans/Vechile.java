...
//@Component   // disable b/c we create bean using @bean in projectConfig
...
public class Vechile {
    ...
    // Problem Statement Example Start here
        // Vehicle class dependency on VehicleServices to make relationship using @autowiring
        private final VehicleServices vehicleServices;

        @Autowired
        public Vechile(VehicleServices vehicleServices) {
