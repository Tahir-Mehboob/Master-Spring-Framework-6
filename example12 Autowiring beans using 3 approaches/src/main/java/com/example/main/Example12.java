...
public class Example12 {
    ...
    public static void main(String[] args) {
        ...
        Vechile v = context.getBean(Vechile.class);
        Person  p = context.getBean(Person.class);

        System.out.println("\n---------------Bean Autowiring Example Start here------------------\n");

        System.out.println("Person name from Spring Context is : "+p.getName());
        System.out.println("Vechile Name from Spring Context is : "+v.getName());
        System.out.println("Vehicle that Person own is :"+p.getVechile()+"\n-----------------------");
      ...
      /*  System.out.println("XML Config for Vechile Name from Spring Context is " + vehicle.getName());
        vehicle.printHello();*/
